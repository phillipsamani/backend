...
exports.create = (req, res) => {
  ...
  form.parse(req, (err, fields) => {
    ...
    section.slug = slugify(title).toLowerCase();
...
// exports.getSyllabusSections = (req, res) => {
//   const slug = req.params.slug.toLowerCase();
//   const { subject } = req.body.syllabus;
//   // console.log(subject)
//   Section.findOne({ slug })
//     .populate("subjects", "_id name slug")
//     .select("_id subjects section identifier title  body")
//     .exec((err, section) => {
//       if (err) {
//         return res.json({
//           error: errorHandler(err),
...
//         .select("_id section identifier title  body")
//         .exec((err, data) => {
//           if (err) {
//             return res.json({
//               error: errorHandler(err),
//             });
//           }
//           res.json({ section, foreword: data });
